...
@ApiModel("更新疾病用量实体")
public class DosageDiseaseUd implements Serializable {
    private static final long serialVersionUID = 1619767367720946113L;

    @ApiModelProperty(value = "疾病用量编号",dataType = "int",required = true)
    @NotBlank(message = "dosageDiseaseId 不能为空")
    @Getter
    @Setter
    private Integer dosageDiseaseId;
